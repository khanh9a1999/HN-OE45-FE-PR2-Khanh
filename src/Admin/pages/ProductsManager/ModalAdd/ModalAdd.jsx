...
import styles from "./ModalAdd.module.sass"
...
import { addProductItemDbJson, getAllProducts } from "../../../../store/slices/ProductSlice"
...
function ModalAdd() {
    ...
    const [detailDescItem, setDetailDescItem] = useState('')
    ...
    const handleSubmit = async (e) => {
        ...
        dispatch(setNotification({type: 'success', message: 'Product add successful'}))
    ...
    return (
        <section className={styles["modal-add"]}>
            ...
            <Form className={styles["form-modal"]}>
                ...
                <Button className="mt-5" variant="outline-primary" type="submit" size="lg" onClick={handleSubmit}>Submit</Button>
            </Form>
        </section>
    );
}
